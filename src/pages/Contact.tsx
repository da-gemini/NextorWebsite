...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, show success - will connect to email backend
  ...
  const inputClass =
    "w-full h-11 px-4 rounded-lg border border-border bg-card text-foreground font-body text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-shadow duration-200";
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Specific requirements, certifications needed, delivery timeline..."
                  rows={4}
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-body text-sm text-foreground">info@nextor.com</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <div>
                    <div className="font-body text-xs text-muted-foreground">Phone</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-body text-xs text-muted-foreground">Office</div>
                    <div className="font-body text-sm text-foreground">Ahmedabad, Gujarat, India</div>
                  </div>
                </div>
              </div>
            </div>
