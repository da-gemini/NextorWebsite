    ...
    <PageTransition>
      <main className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            to="/products"
            className="inline-flex items-center text-sm font-body text-muted-foreground hover:text-foreground mb-6 transition-colors"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div>
              ...
              >
                Request a Quote <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={16} />
              </Link>
            </div>
          </div>
        </div>
